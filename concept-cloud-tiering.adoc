...
https://www.netapp.com/data-services/tiering/tco-calculator/["Verwenden Sie den TCO-Rechner für Cloud Tiering, um zu sehen, wie viel Geld Sie sparen können"^].
...
Nachdem Sie eine Cloud Tiering-Lizenz erworben haben, müssen Sie die Lizenz zur NetApp Console hinzufügen. link:task-licensing-cloud-tiering.html#use-a-cloud-tiering-byol-license["Erfahren Sie, wie Sie eine Cloud Tiering BYOL-Lizenz verwenden"].
...
NOTE: Ab August 2021 wurde die alte * FabricPool*-Lizenz durch die *Cloud Tiering*-Lizenz ersetzt. link:task-licensing-cloud-tiering.html#cloud-tiering-byol-licensing-starting-in-2021["Lesen Sie mehr darüber, wie sich die Cloud Tiering-Lizenz von der FabricPool -Lizenz unterscheidet"].
