...
Um eine Schätzung zu erhalten, fügen Sie Ihren ONTAP Cluster zur NetApp Console hinzu und überprüfen Sie ihn über die Seite „Cloud Tiering Clusters“. Wählen Sie *Potenzielle Tiering-Einsparungen berechnen* für den Cluster aus, um den https://www.netapp.com/data-services/tiering/tco-calculator["TCO-Rechner für Cloud Tiering"^] um zu sehen, wie viel Geld Sie sparen können.
...
* link:task-tiering-onprem-aws.html#preparing-your-ontap-clusters["Tiering von Daten zu Amazon S3"]
