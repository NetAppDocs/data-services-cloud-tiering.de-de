...
. link:task-licensing-cloud-tiering.html#use-a-cloud-tiering-byol-license["Erwerben Sie eine Cloud Tiering-Lizenz"]für die für den bzw. die neuen Cluster benötigte Kapazität.
. In der Konsole<<licenses,Fügen Sie die Lizenz zur digitalen Geldbörse hinzu>> [Lizenz hinzufügen].
. Beim Cloud Tieringlink:task-managing-tiering.html#discovering-additional-clusters-from-cloud-tiering["Entdecken Sie die neuen Cluster"] .
